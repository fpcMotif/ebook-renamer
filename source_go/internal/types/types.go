...
type ParsedMetadata struct {
	...
	Series  *string `json:"series,omitempty"`  // e.g., "GTM 52"
	Edition *string `json:"edition,omitempty"` // e.g., "2nd ed"
	Volume  *string `json:"volume,omitempty"`   // e.g., "Vol 2" (volume info is kept in title)
}
