...
impl OperationsOutput {
    ...
    pub fn from_results(
        ...
        cleanup_targets: Vec<(PathBuf, String)>,
...
mod tests {
    ...
    fn test_from_results() {
        ...
        let files_to_delete = vec![(target_dir.join("small.pdf"), "failed_download".to_string())];
        ...
        assert_eq!(
            output.small_or_corrupted_deletes[0].issue,
            "failed_download"
        );
