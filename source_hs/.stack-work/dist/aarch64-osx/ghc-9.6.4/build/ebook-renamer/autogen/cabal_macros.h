...
/* package ebook-renamer-0.1.0.0 */
#ifndef VERSION_ebook_renamer
#define VERSION_ebook_renamer "0.1.0.0"
#endif /* VERSION_ebook_renamer */
#ifndef MIN_VERSION_ebook_renamer
#define MIN_VERSION_ebook_renamer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ebook_renamer */
...
#define CURRENT_COMPONENT_ID "ebook-renamer-0.1.0.0-KPSvtq9X2sRInEwqvF2YB2-ebook-renamer"
